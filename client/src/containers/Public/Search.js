...
const Search = () => {
    ...
    return (
        <>
            <div className='p-[10px] w-3/5 my-3 bg-yellow-400 rounded-lg flex-col lg:flex-row flex items-center justify-around gap-2' >
                ...
                <button
                    ...
                    className='outline-none py-2 px-4 flex-1 bg-slate-900 rounded-md text-[13.3px] flex items-center justify-center gap-2 text-white font-medium'
                >
                    <FiSearch />
                    Tìm kiếm
                </button>
